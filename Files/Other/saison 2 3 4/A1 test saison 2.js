...
var qstHead;
var groups;
var quizTitle="A1 test saison 2";
var printCpRg=1;
var filename = 'A1 test saison 2';
...
function initShortQuestion() {
 qstHead[0]="Ordnen Sie zu.  das Telefon ?? das Regal ?? die Lampe ?? der Drucker ?? der...";
 qstHead[1]="Was ist das Problem? Ergänzen Sie.  Beispiel    Mein Drucker ist kaputt. Ic...";
 qstHead[2]="Hören und verbinden Sie die Antonyme  ";
 qstHead[3]="Position der Verben.  Beispiel   1. hier - Studenten - können - etwas - ess...";
 qstHead[4]="Was kann man …? Was passt zusammen? Ordnen Sie zu.";
 qstHead[5]="Die Deutschen und ihre Lieblingshobbys a) Ordnen Sie zu.  Freunde besuchen ...";
 qstHead[6]="Was machen Sie gern?  Beispiel. Fahren Sie gern Auto? .Fußball spielen. Nei...";
 qstHead[7]="In der Cafeteria   Hören Sie zuerst den Dialog. Markieren Sie   ";
 qstHead[8]="Was kann man alles sammeln? Ordnen Sie zu. Schlagen Sie unbekannte Wörter i...";
 qstHead[9]="Ergänzen Sie er, sie oder es.  Beispiel Ist dein Büro groß? Nein, es ist kl...";
 qstHead[10]="Bilden Sie Fragen und antworten Sie.  Beispiel Können  du  tanzen? Kannst d...";
 qstHead[11]="Ergänzen Sie die Verben.  ";
 qstHead[12]="Welches Verb passt?  fahren ??  lesen ??  spielen ??  machen ??  können  ??...";
 qstHead[13]="Ergänzen Sie die Präpositionen. an bei nach in aus  Beispiel Peter wohnt in...";
 qstHead[14]="Ergänzen Sie die Fragewörter.  wie  was  wo  woher  welche      Beispiel  W...";
}
...
function Constructor() {
  ...
  typeOfQuest = new init_array(4,4,4,4,4,4,4,2,4,4,4,4,4,4,4);
